...
module.exports = ({
  ...
  bot.onText(/\/admin/, msg => {
    ...
    const adminKeyboardStructure = {
      // Renamed for clarity, this IS the reply_markup object
      inline_keyboard: [
        [
  ...
  bot.on('callback_query', callbackQuery => {
    ...
    // --- Menu Management ---
      ...
      // bot.emit('callback_query', { ...callbackQuery, data: 'admin_update_daily_menu_forward_to_menu_handler' }); // Forwarding example
    ...
    // --- Feedback Management ---
      ...
      }); // Here inline_keyboard is directly an array of arrays of buttons
      bot.answerCallbackQuery(callbackQuery.id);
  ...
  bot.on('message', async msg => {
    ...
    // --- Handle Broadcast Message ---
      ...
      if (text && text === 'HA YUBORILSIN') {
        ...
        adminData.adminUserIds.forEach(id => knownUserIds.add(id)); // Corrected this line
